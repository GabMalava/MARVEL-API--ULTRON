     ...
     async findById(id: string) {
      ...
      async delete(id: string) {
        try {
            ...
            throw new Error(`Error to delet characters: ${error}`)    
       } 
       ...
       async fetchAndStoreCharacters() {
        try {
          const response = await axios.get(
            `{"resourceURI":"
            https://gateway.marvel.com:443/v1/public/series/1067/characters?apikey=f1d75b477233f6295f2e168358f0b9ed&ts=1&hash=ae8761b32df4792b243892e608a4661b`
          );
          ...
          console.log("The charter has been saved in BD.");
        } catch (error) {
          console.error(`Error searching for charter: ${error}`);
        }
      }
